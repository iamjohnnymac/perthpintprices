 ...
 *
 * Usage:
 *   node scripts/mark-dnc.mjs --slug <pub-slug> [--reason "angry bartender"]
 *   node scripts/mark-dnc.mjs --slug <pub-slug> --undo
 *
 * Examples:
 *   node scripts/mark-dnc.mjs --slug royal-fremantle-golf-club --reason "asked not to call back"
 *   node scripts/mark-dnc.mjs --slug royal-fremantle-golf-club --undo
 */
