...
- Exchange Bar remains a documented stale-cohort example: it was listed as crawled-not-indexed but stored URL Inspection on 2026-07-21 showed it indexed. Federal Hotel is a separate missing-price representative: its live test was indexable, while stored GSC remained unknown.
