...
- **Verification:** 356 unit tests, TypeScript, lint, redirect and security-header contracts, and the Infisical-backed production build pass against 849 pubs. Raw HTML contained all five data-tool links, TBC pub recommendations and all 63 legitimate Fremantle pub links before hydration. Desktop/mobile before-and-after evidence is in `artifacts/visible-link-rails-233/`.
