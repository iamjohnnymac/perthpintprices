...
- **Issue #230:** superseded the earlier Tier-C noindex policy. Price availability, verification, and freshness now classify the page's trust/presentation state only; they do not hide a pub, change its canonical, emit `noindex`, or exclude it from the sitemap.
