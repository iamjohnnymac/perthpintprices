...
The same test also exercises the checked-in Andrew MP3: playback advances, the ended state can replay, reset pauses and seeks to zero, and the sequence completes with reduced motion enabled. No phone call was placed.
