          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-5">
            <div className="flex items-center gap-3 bg-stone-50 rounded-xl px-4 py-3 border border-stone-100">
              <div className="w-9 h-9 rounded-lg bg-blue-50 flex items-center justify-center">
                <span className="text-blue-500 text-sm font-bold">{E.chart}</span>
              </div>
              <div>
            ...
            <div className="flex items-center gap-3 bg-stone-50 rounded-xl px-4 py-3 border border-stone-100">
              <div className="w-9 h-9 rounded-lg bg-green-50 flex items-center justify-center">
                <span className="text-green-500 text-sm font-bold">{E.money}</span>
              </div>
              <div>
            ...
            <div className="flex items-center gap-3 bg-stone-50 rounded-xl px-4 py-3 border border-stone-100">
              <div className="w-9 h-9 rounded-lg bg-amber-50 flex items-center justify-center">
                <span className="text-amber-500 text-sm font-bold">{E.beer}</span>
              </div>
              <div>
            ...
            <div className="flex items-center gap-3 bg-stone-50 rounded-xl px-4 py-3 border border-stone-100">
              <div className="w-9 h-9 rounded-lg bg-emerald-50 flex items-center justify-center">
                <span className="text-emerald-500 text-sm font-bold">{E.cheers}</span>
              </div>
              <div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          {filteredPubs.length > INITIAL_PUB_COUNT && (
            ...
            >
              ...
              <span className={`inline-block transition-transform ${showAllPubs ? 'rotate-180' : ''}`}>{E.arrowDown}</span>
            </button>
          )}
        </div>
                    ...
                    >
                      ...
                      <td className="py-3 px-4 hidden md:table-cell">
                        {pub.happyHour ? (
                          ...
                          <span className="text-xs text-stone-400">{E.dash}</span>
                        )}
                      </td>
        ...
        {filteredPubs.length === 0 && (
          <div className="text-center py-12 bg-white rounded-xl border border-stone-200">
            <div className="text-5xl mb-3">{E.search}</div>
      ...
      <footer className="bg-stone-800 text-white py-8 mt-8">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-wrap justify-center gap-6 mb-6 pb-6 border-b border-stone-700">
            <div className="flex items-center gap-2">
              <span className="text-2xl">{E.beer}</span>
              <div>
            ...
            <div className="flex items-center gap-2">
              <span className="text-2xl">{E.champagne}</span>
              <div>
          ...
          <div className="text-center">
            <p className="text-stone-300 text-sm">{E.beer} Perth Pint Prices {E.dash} Helping you find cheap drinks since 2024</p>
