...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.perthpintprices.com/guides/punt-and-pints' },
  openGraph: {
    title: "Punt & Pints — Perth Pubs with TAB | Arvo",
    description: "Perth pubs with TAB facilities. Watch the races with a cold pint.",
    url: 'https://www.perthpintprices.com/guides/punt-and-pints',
    type: 'website',
    siteName: 'Arvo',
  },
}
  ...
  return (
    <>
      <BreadcrumbJsonLd items={[
        ...
        { name: 'Guides', url: 'https://www.perthpintprices.com/guides' },
        { name: 'Punt & Pints' },
      ]} />
      <PuntAndPintsPage />
    </>
