          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h3 className="text-base sm:text-lg font-bold font-heading text-stone-800 flex items-center">Beer Weather<InfoTooltip text="Weather from the Bureau of Meteorology, updated every 30 min. We pick pubs based on whether it's a beer-garden day or a hunker-down day." /></h3>
                {isWindy && (
