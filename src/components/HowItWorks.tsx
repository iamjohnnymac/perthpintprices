  ...
  return (
    <section className="py-6">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
        ...
        <p className="text-stone-warm mb-2 text-sm">No app download. No sign-up. Just prices.</p>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {steps.map((step) => (
            <div key={step.num} className="text-center">
              <div className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-amber/10 text-amber font-mono font-bold text-sm mb-2">
                {step.num}
              </div>
