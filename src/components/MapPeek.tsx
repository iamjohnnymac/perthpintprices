  ...
  if (!visible) {
    return (
      <button
        ...
        className="flex items-center gap-2.5 text-sm font-semibold text-ink bg-white border border-gray-light hover:border-amber/40 hover:bg-amber/5 rounded-full px-4 py-2 mb-4 transition-all shadow-sm focus-visible:ring-2 focus-visible:ring-amber/50 focus-visible:ring-offset-1"
      >
        ...
        Show map
        {happyHourCount > 0 && (
          <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-ink bg-amber-pale rounded-full px-2 py-0.5">
    ...
    <div className="mb-4">
      <div className="flex items-center justify-between mb-2">
        <button
          ...
          className="flex items-center gap-1.5 text-xs font-medium text-gray-mid hover:text-ink transition-colors"
        >
