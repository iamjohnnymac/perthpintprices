...
const tabs: { id: TabId; label: string; activeIcon: JSX.Element; inactiveIcon: JSX.Element }[] = [
  {
    ...
    label: 'Pubs',
    activeIcon: (
      <svg viewBox="0 0 24 24" className="w-[20px] h-[20px]" fill="currentColor" stroke="none">
        <path d="M5 3a1 1 0 011-1h12a1 1 0 011 1v1H5V3zm0 2h14v14a3 3 0 01-3 3H8a3 3 0 01-3-3V5zm4-2v3h2V3H9zm4 0v3h2V3h-2z" />
      </svg>
    ),
    inactiveIcon: (
      <svg viewBox="0 0 24 24" className="w-[20px] h-[20px]" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            return (
              ...
              >
                ...
                {tab.id === 'market' && crowdCount > 0 && (
                  <span className="absolute top-2 right-1/4 flex items-center justify-center w-1.5 h-1.5 rounded-full bg-brand-500 ring-2 ring-white" />
                )}
