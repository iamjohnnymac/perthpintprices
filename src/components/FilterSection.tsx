      ...
      <div className="flex flex-wrap gap-2.5 items-center">
        ...
        {beerTypes.length > 0 && setBeerTypeFilter && (
          <select
            ...
            className="flex-1 min-w-[140px] font-body text-[0.9rem] font-semibold bg-white border-3 border-ink rounded-pill px-4 py-3 text-ink appearance-none cursor-pointer bg-[url('data:image/svg+xml,%3Csvg%20width%3D%2712%27%20height%3D%278%27%20viewBox%3D%270%200%2012%208%27%20fill%3D%27none%27%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%3E%3Cpath%20d%3D%27M1%201.5L6%206.5L11%201.5%27%20stroke%3D%27%23171717%27%20stroke-width%3D%272.5%27%20stroke-linecap%3D%27round%27%2F%3E%3C%2Fsvg%3E')] bg-no-repeat bg-[right_14px_center] pr-9"
          >
